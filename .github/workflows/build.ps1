...
if ($IsWindows) {
    ...
    Execute "cmake" "-G ""Unix Makefiles"" -DCMAKE_BUILD_TYPE=$BuildType -DQUIC_TLS=$Tls -DQUIC_BUILD_SHARED=$Shared -DMSH3_SERVER_SUPPORT=$Server -DMSH3_TEST=$Test -DMSH3_TOOL=$Tool .."
    Execute "cmake" "--build ."
